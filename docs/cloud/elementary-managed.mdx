...
Elementary Cloud is a managed service that offers orchestration and hosting of Elementary data observability report and Slack alerts as a service.

_The service is currently in private beta, you can [sign up](https://www.elementary-data.com/cloud-beta) for details._
...
# Onboarding to Elementary Cloud

1. Read the [Terms of Service](https://www.elementary-data.com/terms-of-service), and send us a <a href="mailto:team@elementary-data.com?subject=I want to try Elementary managed!&body=I accept the Terms of Service of Elementary Cloud. Please send me an onboarding link.">confirmation email</a>.
...
For details, refer you our [Terms of Service](https://www.elementary-data.com/terms-of-service).
